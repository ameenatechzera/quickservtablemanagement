...
import 'package:quickservtablemanagement/core/widgets/app_snackbar.dart';
...
import 'package:quickservtablemanagement/fetaures/authentication/presentation/widgets/custom_textfield.dart';
import 'package:quickservtablemanagement/fetaures/authentication/presentation/widgets/login_locks.dart';
import 'package:quickservtablemanagement/fetaures/authentication/presentation/widgets/three_dot_loader.dart';
          ...
          listener: (context, state) async {
            if (state is LoginSuccess) {
              ...
              try {
                ...
                /// Save User ID
                await SharedPreferenceHelper().setUserId(
                  state.loginResponse.data.first.id,
                );
                print('reached_2');
                ...
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (_) => TableHomescreen()),
                );
                return;
              } catch (e) {
                isProcessing.value = false;
